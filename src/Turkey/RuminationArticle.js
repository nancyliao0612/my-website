  ...
  return (
    <div>
      ...
      <div className="DB-center">
        ...
        <p>
          多虧那一段時間的練習，讓我初到土耳其時，不至於太過沖擊。點餐時，可以認得菜單上的少量單字（雖然無可避免的還是有種我在看火星文的感覺哈哈哈）；可以進行簡單問候、道謝；當有人問我有沒有學過土語時，我也有些小小心得可以分享～
        </p>
        <br />
        <p>
          由於當地人普遍不說英文，所以真心建議如果學校土語的課沒有跟你系上想選的課衝突（我就是因為衝堂😭），一定要去選！！
        </p>
        <p>
        ...
        <br />
        <p>有一次我在 Migros 超市想買抽取式衛生紙，但東找西找就是沒看到</p>
        <p>
          於是我一邊秀出 google
        ...
        <p>
          我都會事先用 google
          翻譯，查好那個物品的土耳其文，然後把那句話默念幾次記下來，並自己親口向店員說出來。
        </p>
        ...
        <p>最後，也讓我順利找到僅收取 2.5 % 手續費的一間銀行。</p>
        <br />
        <b>換匯</b>
        <p>
        ...
        <p>
          我在土耳其交換短短四個月期間，美元比里拉的匯率曾最高飆到 18.3；最低到
          8.8
        </p>
        ...
        <br />
        <p>這不是我第一次訂 Airbnb，但到是我第一次遇到如此不誠實的屋主</p>
        <p>
          現在想想，覺得當時應該捍衛自己權益，相信 Airbnb
          也有針對特殊案例的退款機制
        </p>
        <p>也怪自己太粗枝大葉，相信屋主的一言堂，沒有事先一一確認這些資訊</p>
        <br />
        <b>第二～四個月：租土耳其朋友的公寓</b>
        <p>公寓大約 40 坪，共用廚房和浴室，而我們兩人都有各自的房間</p>
        <p>
          這間公寓相較上間寬敞許多，價位幾乎是 Airbnb 的 1/3，且周圍生活機能佳
        </p>
        <br />
        <p>不過，入住時還是遇到一個小插曲～</p>
        <p>由於房東忘記幫我們打開瓦斯，入住才發現沒有熱水可以洗澡。</p>
        <p>好巧不巧發現的那一天正逢土耳其國慶日，連放了三天假期....</p>
        <p>房東也很豪爽，直接把我和我室友接回他們家住了三天～</p>
        <br />
        <p>
          根據這些經驗，我列了以下十點在租屋前必須仔細確認的清單！（我真的就是菜鳥租屋...）
        </p>
        <br />
        <ul className="text-bullet">
          ...
          <li>是否有清潔工具</li>
          <li>
            索取足夠的房屋鑰匙（至少要和室友一人一把，不然每天喬回家時間真的超級麻煩）
          </li>
          <li>洗衣機使用方式</li>
        ...
        <p>
          另外，國外洗衣機真的跟台灣很不一樣，要記得請屋主實際操作一次洗衣機的使用方式、深色和淺色衣服是否要分開洗？
        </p>
        <p>
        ...
        <p>
          出發前，我最慌恐的就是怕交不到朋友（我知道認識我的人看到只想翻我白眼XD）
        </p>
        <br />
        <p>
        ...
        <p>
          而身為一位在異鄉的交換生，就像是小小外交官，代表外國人對台灣的印象！
        </p>
        <p>
          所以真心建議，像是「台灣的食物、文化歷史、中國與台灣的關係XDD、為什麼想來土耳其」等等很容易會被問爆的問題，都可以花點心思準備～（有些人可能天生口才就很好，但如果你跟我一樣跟陌生人講話常常會口吃、不知所措的話，真的可以先打個草稿ㄛ）
        </p>
        <br />
        <div className="devider">
          <BsDot className="dot" />
        ...
        <h3>後記</h3>
        <p>轉瞬間，在伊斯坦堡的交換之旅已悄然結束。</p>
        <br />
        <p>不敢說自己成長蛻變了多少，僅敢說自己變得更加圓潤、有韌性</p>
        <p>身在崎嶇難行的谷底，學習泰然接受生命遭遇的挫折與失落。</p>
        <p>身在晴空萬里的山峰，學習安然享受生命賦予的禮物與祝福。</p>
        <br />
        <p>也讓我更有勇氣面對人生的下個階段～</p>
        <p>是的，要面對現實找工作啦😭....希望不要失業 XDD</p>
        <br />
      </div>
    </div>
  );
