  ...
  return (
    <section className="DB-background">
      ...
      <div className="DB-center">
        ...
        聊著聊著也就一路跟著他們的速度走。
        <br />
        對我來說是很甜蜜的配速，不輕鬆但也不會疲倦到亂了自己行走的步調，結果最後花
        3 小時 20 分就到九九山莊了！
        <br />
        ...
        <br />
        <br />
        抵達後，莊主會帶你到登記處簽名報到，記得攜帶「身份證以及入園證」出示。
        <br />
        ...
        <br />
        <br />
        和家人報完平安後，第一件事情就直接倒頭大睡，累到連鬧鐘都忘記設，後來是被空空的肚子餓醒，才想到自己還沒吃晚餐。
        <br />
        環顧四周漆黑的一片，我躡手躡腳起身到食堂燒水煮泡麵，飽餐一頓後滿足地回去入睡～
        <br />
        <br />
        ...
        <br />
        <img src="https://i.imgur.com/YwEEETi.jpg" alt="" />
        <br />
        <h3>Day 3</h3>
        清晨 4:30 從九九山莊出發
        <br />
